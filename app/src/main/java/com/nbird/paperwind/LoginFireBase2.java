       ...
       /* if (user != null) {
        ...
        googsignin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                loadingDialog = new Dialog(LoginFireBase2.this);
                ...
                mAuth.signInWithEmailAndPassword(email, password1).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (!night) {
                                AlertDialog.Builder builder = new AlertDialog.Builder(LoginFireBase2.this, R.style.AlertDialogTheme);
                                View view1 = LayoutInflater.from(LoginFireBase2.this).inflate(R.layout.guide_alertdialog, (ConstraintLayout) findViewById(R.id.layoutDialogContainer));
                                                        ...
                                                        table_user.child(mAuth.getCurrentUser().getUid()).child("personal").setValue(s1).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                if (task.isSuccessful()) {
                                                                    ...
                                                                    Toast.makeText(LoginFireBase2.this, "Record Not Saved!", Toast.LENGTH_LONG).show();
                                                                }
                                                            }
                                                        });
                                                    } catch (Exception e) {
